...
/**
 * Stub mínimo de TogareLogger para testes unit standalone do
 * togare-nextcloud-bridge (Story 5.1).
 *
 * Carregado pelo bootstrap.php apenas se a classe real não estiver disponível.
 * Em runtime real do EspoCRM, togare-core fornece a impl correta.
 *
 * Recording opcional via `getRecorded()` — usado em testes que querem
 * assert sobre eventos de log emitidos (ex.: `nextcloud.client.cb_opened`).
 */
