...
/**
 * Script CLI para rollback manual de uma migration do togare-licensing.
 *
 * Uso (dentro do container EspoCRM):
 *   php /var/www/html/custom/Espo/Modules/TogareLicensing/Migration/rollback.php V001__create_togare_module_status
 *
 * Reusa o MigrationRunner do togare-core (dependência do extension.json).
 * Credenciais PDO vêm do EspoCRM config (data/config-internal.php).
 */
...
if ($argc < 2) {
    ...
    fwrite(STDERR, "Ex.: php rollback.php V001__create_togare_module_status\n");
    exit(2);
}
