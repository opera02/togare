...
// Bootstrap para testes unit do togare-djen.
...
// Autoload do próprio togare-djen (deps dev + PSR-4 Espo\Modules\TogareDjen\*).
...
require __DIR__ . '/tests/unit/Espo/Modules/TogareDjen/Stubs/CoreStubs.php';
...
if (! class_exists(\Espo\ORM\EntityManager::class, false)) {
    require __DIR__ . '/tests/unit/Espo/Modules/TogareDjen/Stubs/EntityManagerStub.php';
}
...
if (! class_exists(\Espo\Modules\TogareCore\Services\TogareLogger::class, false)) {
    require __DIR__ . '/tests/unit/Espo/Modules/TogareDjen/Stubs/TogareLoggerStub.php';
}
